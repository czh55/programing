...
-- ----------------------------
-- Table structure for programing_application
-- ----------------------------
DROP TABLE IF EXISTS `programing_application`;
CREATE TABLE `programing_application` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '报名id',
  `application_no` bigint(20) DEFAULT NULL COMMENT '报名号',
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_no_index` (`application_no`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=144 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of programing_application
-- ----------------------------
BEGIN;
INSERT INTO `programing_application` VALUES (131, 1527064980260, 22, 1, 300.00, 1, 20, '2018-05-23 16:43:09', NULL, NULL, '2018-05-23 16:42:59', '2018-05-23 16:43:10');
INSERT INTO `programing_application` VALUES (132, 1527142954206, 22, 1, 600.00, 1, 0, NULL, NULL, NULL, '2018-05-24 14:22:34', '2018-05-24 14:22:34');
INSERT INTO `programing_application` VALUES (133, 1527176721079, 22, 1, 200.00, 1, 20, '2018-05-24 23:46:39', NULL, NULL, '2018-05-24 23:45:20', '2018-05-24 23:46:40');
INSERT INTO `programing_application` VALUES (134, 1527181598655, 22, 22, 20.00, 1, 40, '2018-05-25 01:06:53', NULL, NULL, '2018-05-25 01:06:38', '2018-05-25 01:07:09');
INSERT INTO `programing_application` VALUES (135, 1527207018106, 22, 22, 20.00, 1, 0, NULL, NULL, NULL, '2018-05-25 08:10:17', '2018-05-25 08:10:17');
INSERT INTO `programing_application` VALUES (136, 1527213374765, 22, 22, 20.00, 1, 0, NULL, NULL, NULL, '2018-05-25 09:56:14', '2018-05-25 09:56:14');
INSERT INTO `programing_application` VALUES (137, 1527219024790, 22, 22, 20.00, 1, 0, NULL, NULL, NULL, '2018-05-25 11:30:24', '2018-05-25 11:30:24');
INSERT INTO `programing_application` VALUES (138, 1527497220985, 22, 22, 20.00, 1, 40, '2018-05-28 16:47:40', NULL, NULL, '2018-05-28 16:47:00', '2018-06-06 14:35:26');
INSERT INTO `programing_application` VALUES (139, 1528033495860, 22, 1, 200.00, 1, 0, NULL, NULL, NULL, '2018-06-03 21:44:54', '2018-06-03 21:44:54');
INSERT INTO `programing_application` VALUES (140, 1528452169916, 22, 1, 300.00, 1, 20, '2018-06-08 18:05:36', NULL, NULL, '2018-06-08 18:02:49', '2018-06-08 18:05:38');
INSERT INTO `programing_application` VALUES (141, 1528514816027, 22, 1, 99.00, 1, 0, NULL, NULL, NULL, '2018-06-09 11:26:55', '2018-06-09 11:26:55');
INSERT INTO `programing_application` VALUES (143, 1528534914889, 22, 1, 1.00, 1, 10, NULL, NULL, NULL, '2018-06-09 17:01:54', '2018-06-09 17:01:54');
COMMIT;

-- ----------------------------
-- Table structure for programing_application_item
-- ----------------------------
DROP TABLE IF EXISTS `programing_application_item`;
CREATE TABLE `programing_application_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '报名子表id',
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
  `sponsor_id` int(11) DEFAULT NULL COMMENT '主办方id',
  `application_no` bigint(20) DEFAULT NULL COMMENT '报名号',
  ...
  `current_unit_price` decimal(20,2) DEFAULT NULL COMMENT '生成报名表时的比赛报名费，单位是元,保留两位小数',
  `quantity` int(10) DEFAULT NULL COMMENT '比赛数量',
  `total_price` decimal(20,2) DEFAULT NULL COMMENT '比赛总价,单位是元,保留两位小数',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`),
  KEY `order_no_index` (`application_no`) USING BTREE,
  KEY `order_no_user_id_index` (`user_id`,`application_no`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=161 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of programing_application_item
-- ----------------------------
BEGIN;
INSERT INTO `programing_application_item` VALUES (148, 22, 1, 1527064980260, 26, '蓝桥杯', 'd8c53aee-5e1c-46d6-bec4-6552403d099d.jpg', 300.00, 1, 300.00, '2018-05-23 16:42:59', '2018-05-23 16:42:59');
INSERT INTO `programing_application_item` VALUES (149, 22, 1, 1527142954206, 26, '蓝桥杯', 'd8c53aee-5e1c-46d6-bec4-6552403d099d.jpg', 300.00, 2, 600.00, '2018-05-24 14:22:34', '2018-05-24 14:22:34');
INSERT INTO `programing_application_item` VALUES (150, 22, 1, 1527176721079, 27, '甲骨文杯', 'b4c388c0-2dc9-4918-b267-9aadfc2c1425.jpg', 200.00, 1, 200.00, '2018-05-24 23:45:20', '2018-05-24 23:45:20');
INSERT INTO `programing_application_item` VALUES (151, 22, 22, 1527181598655, 31, '山西省第一届ACM竞赛', '117ecba1-23f7-48ff-a085-674f32e51731.jpeg', 20.00, 1, 20.00, '2018-05-25 01:06:38', '2018-05-25 01:06:38');
INSERT INTO `programing_application_item` VALUES (152, 22, 22, 1527207018106, 31, '山西省第一届ACM竞赛', '117ecba1-23f7-48ff-a085-674f32e51731.jpeg', 20.00, 1, 20.00, '2018-05-25 08:10:18', '2018-05-25 08:10:18');
INSERT INTO `programing_application_item` VALUES (153, 22, 22, 1527213374765, 31, '山西省第一届ACM竞赛', '117ecba1-23f7-48ff-a085-674f32e51731.jpeg', 20.00, 1, 20.00, '2018-05-25 09:56:14', '2018-05-25 09:56:14');
INSERT INTO `programing_application_item` VALUES (154, 22, 22, 1527219024790, 31, '山西省第一届ACM竞赛', '117ecba1-23f7-48ff-a085-674f32e51731.jpeg', 20.00, 1, 20.00, '2018-05-25 11:30:24', '2018-05-25 11:30:24');
INSERT INTO `programing_application_item` VALUES (155, 22, 22, 1527497220985, 31, '山西省第一届ACM竞赛', '117ecba1-23f7-48ff-a085-674f32e51731.jpeg', 20.00, 1, 20.00, '2018-05-28 16:47:00', '2018-05-28 16:47:00');
INSERT INTO `programing_application_item` VALUES (156, 22, 1, 1528033495860, 27, '甲骨文杯', 'b4c388c0-2dc9-4918-b267-9aadfc2c1425.jpg', 200.00, 1, 200.00, '2018-06-03 21:44:54', '2018-06-03 21:44:54');
INSERT INTO `programing_application_item` VALUES (157, 22, 1, 1528452169916, 26, '蓝桥杯', 'd8c53aee-5e1c-46d6-bec4-6552403d099d.jpg', 300.00, 1, 300.00, '2018-06-08 18:02:49', '2018-06-08 18:02:49');
INSERT INTO `programing_application_item` VALUES (158, 22, 1, 1528514816027, 30, 'ACM国际大学生程序设计竞赛', 'b4c5e2da-4d53-4c45-ac6f-da713f5ca9cc.jpg', 99.00, 1, 99.00, '2018-06-09 11:26:55', '2018-06-09 11:26:55');
INSERT INTO `programing_application_item` VALUES (160, 22, 1, 1528534914889, 33, '美女1', '577f7cda-ebf7-467e-a19b-dd505bbc69e9.jpeg', 1.00, 1, 1.00, '2018-06-09 17:01:54', '2018-06-09 17:01:54');
COMMIT;
...
-- ----------------------------
-- Table structure for programing_favourite
-- ----------------------------
DROP TABLE IF EXISTS `programing_favourite`;
CREATE TABLE `programing_favourite` (
...
-- ----------------------------
-- Records of programing_favourite
-- ----------------------------
BEGIN;
INSERT INTO `programing_favourite` VALUES (126, 21, 26, 1, 1, '2017-04-13 21:27:06', '2017-04-13 21:27:06');
INSERT INTO `programing_favourite` VALUES (144, 22, 27, 0, 0, '2018-06-03 23:05:20', '2018-06-08 18:36:52');
INSERT INTO `programing_favourite` VALUES (147, 22, 30, 1, 0, '2018-06-09 16:53:00', '2018-06-09 17:20:17');
COMMIT;
...
INSERT INTO `programing_pay_info` VALUES (75, 22, 1528452169916, 1, '2018060821001004300200384966', 'TRADE_SUCCESS', '2018-06-08 18:05:38', '2018-06-08 18:05:38');
COMMIT;
...
INSERT INTO `programing_user` VALUES (22, 'chen', 'D8F80B67499E434EA61ADAF6E6219BF2', 'czh55@qq.com', '15135188999', '问题', '答案', 1, '2018-05-06 14:54:57', '2018-06-09 12:15:23');
